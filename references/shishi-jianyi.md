...
来源：《普通高中语文课程标准（2017年版2020年修订）》「七、实施建议」。保留原文表述。
含：教学与评价建议、学业水平考试与高考命题建议、教材编写建议、课程资源的利用与开发、地方和学校实施本课程的建议。

> ⚠️ **版本状态：本文件正文为 2020 年修订版原文，尚未替换为 2025 年修订版。**
> 2025 版全文未公开取得，故不作改写。已核实的修订点列于下；**未列出的部分不等于未修订**，引用前须核对正式文本。
>
> | 位置 | 2025 版已核修订点 |
> |---|---|
> | 教学建议第 5 条 | 整条改写为"教师要关注**信息化时代日常生活中语言文字运用的新现象和新特点**，把握**信息技术与语文教学深度融合**的趋势，充分发挥信息技术在语文教学变革中的价值和功能"（2020 版为"探索信息化背景下教与学方式的转变……打破唯技术至上的观念"） |
> | 教学建议（新增） | 新增"利用具有交互功能的网络学习空间，创设**线上线下一体化的"混合式"学习生态**" |
> | 评价建议 | 新增"**避免机械训练**"；新增分类评价重点——**必修重基础性、选择性必修重广度、选修重深度**；第 4 条删除部分内容 |
> | 教材编写建议 | 新增"教材的设计应探索**人工智能快速发展环境下的革新**"；新增"**用好红色资源**" |
> | 课程开发与设计 | "特色资源"扩展为"利用本学校、本地区的**特色资源、红色资源**" |
> | 学业水平考试与高考建议 | 由三部分**扩展为五部分**；新增"考查内容、考查要求、考查载体"三位一体模式；情境创设细化三类情境内涵；任务设计新增"任务一般由**多个有逻辑关联的题目**组成"；新增"学业水平合格性考试**可探索口语交际测试**" |
>
