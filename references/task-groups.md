...
来源：《普通高中语文课程标准（2017年版2020年修订）》「五、课程内容」。
本文件保留原文表述，去除了页码与页眉。

> ⚠️ **版本状态：本文件正文为 2020 年修订版原文，尚未替换为 2025 年修订版。**
> 2025 版全文未公开取得，故不作改写。已核实的修订点列于下；**未列出的条目不等于未修订**，引用前须核对正式文本。
>
> | 任务群 | 2025 版已核修订点 |
> |---|---|
> | 3 跨媒介阅读与交流 | 「学习目标与内容」第 1 条第 3 点整体改写：由"关注当代网络文学和网络文化，坚持正确的价值导向，辩证分析网络对语言、文学的影响，提高语言、文学的鉴赏能力"改为"关注**社会主义先进文化、革命文化和中华优秀传统文化在不同媒介的传播形态和路径**，在阅读和交流中学习**讲好中国故事、传播好中国声音**" |
> | 4 语言积累、梳理与探究 | 该任务群第 1 条第 2 点被删除 |
> | 6 思辨性阅读与表达 | 第 1 条第 1 点在"阅读近期重要的时事评论"后新增"**把握其观点、立场**"；第 2 条第 1 点新增举例"**文化自信、文明交流互鉴、绿色发展**" |
> | 8 中华传统文化经典研习 | 前言新增"**古为今用**" |
> | 9 中国革命传统作品研习 | 第 2 条第 3 点新增"**用好红色资源**""**见贤思齐，争做先锋**" |
> | 13 汉字汉语专题研讨 | 第 1 条第 1 点在"必修"后新增"**选择性必修**" |
> | 17 跨文化专题研讨 | 前言新增"弘扬**和平、发展、公平、正义、民主、自由的全人类共同价值**" |
>
> 完整对照与可信度分级见 `references/banben-duibiao.md`。
